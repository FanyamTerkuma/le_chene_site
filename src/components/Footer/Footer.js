		...
		<div className='w-full bg-[#3fe0d0] py-8 px-5'>
			<div className='w-full grid grid-cols-6 max-w-5xl mb-10 mx-auto'>
				<div className='col-span-2'>
					<img src={logoIcon} className='h-14 object-contain mb-2' alt='le-cheneIcon' />

					<FooterItem name='Lekki Gardens Horizontal Two Extention' icon={<HiLocationMarker />} />
					<FooterItem name='08037183004, 08188880374' icon={<BsFillTelephoneFill />} />
				...
				<div className='pt-4 col-span-2'>
					...
					<div className='w-full mt-4 bg-white rounded-md flex items-center'>
						<input type='text' className='bg-transparent outline-none px-3 py-1 text-xs flex-grow' />
			...
			<h4 className='text-sm text-slate-900 w-max mx-auto'>&copy; Copyright le Chene. All rights reserved</h4>
		</div>
	);
};
