    ...
    <div className="w-full flex relative">
      <div className="ml-32 flex items-center w-full max-w-4xl space-x-5 mt-10">
        <div className="font-normal md:text-xl w-2/3">
          ...
          <p className="text-base mt-5 mb-14">
            {/* product description */}
          ...
          <Button title="Custom Order" transparent />

          <p className="text-sm mt-5 max-w-sm text-gray-700">
            Find something you love . customize your search and get your desired
            result.
          </p>
        </div>
      ...
      <aside className="hidden md:block md:absolute z-[-10] w-[25em] h-[140vh] right-0 top-[-90%] bg-[#3FE0D0]">
